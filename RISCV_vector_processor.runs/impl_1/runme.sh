...
HD_PWD='D:/Vivado Workplace/RISCV_vector_processor/RISCV_vector_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VPU.tcl -notrace
